...
功能參考自 [Pixelle-Video](https://github.com/AIDC-AI/Pixelle-Video)（主題 → 分鏡 → 逐幀合成的管線、可替換的 ComfyUI 工作流）與 [ArcReel](https://github.com/ArcReel)（專案制工作台、可編輯的分鏡與逐場景重生成、任務佇列與進度追蹤）。
